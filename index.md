...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-178738326-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-178738326-1');
</script>
...
#### Responsibilities
- 2.5+ years of experiences as Software Engineer/Python developer
...
<iframe width="560" height="315" src="/images/bot video.mp4" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
...
<tbody>
  <tr>
    ...
    <td class="tg-wz43">February, 2021</td>
    <td class="tg-wz43">2.5 years</td>
  </tr>
  <tr>
